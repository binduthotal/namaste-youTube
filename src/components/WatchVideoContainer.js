...
const WatchVideoContainer = () => {
    ...
    return (
        <div id="watchContainer" className="col-span-6">
        <div className="ml-5 pr-5 relative mt-8 grid grid-cols-6 gap-5 w-full">
            <div className="col-span-4">
                ...
                <div className="rounded-lg bg-gray-200 my-2 p-3">
                    <div className="flex  py-2">
                        <p className="font-semibold mr-2">{statistics?.viewCount} views</p>
